...
Currently, the general function `naive_bayes()` supports following class conditional distributions: 
...
Also few helper functions are provided that are supposed to improve the user experience. The `naive_bayes()` function is also available through the excellent `Caret` package. 
