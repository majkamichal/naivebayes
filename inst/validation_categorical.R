...
# GOAL: Check if the results are correct and consistent among different functions
...
# 1) naive_bayes
# 1.1) Categorical
# naive_bayes vs e1071::naiveBayes vs klaR::NaiveBayes
...
# Check posterior probabilities
pred_nb_bern_na <- predict(nb_bern_na, newdata = test_bern_na, type = "prob")
pred_nb_bern2_na <- nb_bern_na %prob% test_bern_na
pred_bnb_na <- predict(bnb_na, newdata = X_bern_test_na, type = "prob")
pred_e10_bern_na <- predict(e10_bern_na, newdata = test_bern_na, type = "raw")
